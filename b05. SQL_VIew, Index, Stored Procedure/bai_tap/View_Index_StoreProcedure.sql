...
values ('Sp01', 'SmartPhone', 5000000, 1, 'new', 0),
...
select *
from product
where productCode = 'Sp01';
create
index index_productCode on product(productCode);

explain
select *
from product
where productName = 'SmartPhone'
  and productPrice = '5000000';
create
index index_produt1 on product(productName, productPrice);
...
update product_view
set productName = 'Notebook'
where productCode = 'SP03';
...
create procedure add_product(pCode varchar (50), pName nvarchar(50), pPrice double, pAmount int,
                             pDescription nvarchar(50), pStatus tinyint)
begin
insert into product (productCode, productName, productPrice, productAmount, productDescription, productStatus)
...
create procedure update_product(pCode varchar (50), pName nvarchar(50), pPrice double, pAmount int,
                                pDescription nvarchar(50), pStatus tinyint)
begin
update product
